...
public class hospitalInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Saving lives since 2022.Our doctors are highly experienced at curing patients with \nWhatsapp forwards. Become our first patient and get full refund if you die during surgeries:)\n\nNote : Refund will only be issued to the patient, in person.");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 640, 120));
